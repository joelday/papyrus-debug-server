...
#define F4SE_VERSION_INTEGER_BETA	17
#define F4SE_VERSION_VERSTRING		"0, 0, 6, 17"
...
#define CURRENT_RELEASE_RUNTIME		RUNTIME_VERSION_1_10_138
#define CURRENT_RELEASE_F4SE_STR	"0.6.17"
