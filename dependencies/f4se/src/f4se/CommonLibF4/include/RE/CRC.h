...
#include "f4se_common/Relocation.h"  // RelocAddr
...
namespace RE
{
	...
	namespace Impl
	{
		...
		{
			CalculateCRC32_32(&a_crc32, a_data, 0);
		}


		inline void CalcCRC32_64(UInt32& a_crc32, UInt64 a_data)
		{
			CalculateCRC32_64(&a_crc32, a_data, 0);
		}

		inline void CalcCRC32_SIZE_P(UInt32& a_crc32, const void* a_data, UInt32 a_size, UInt32 a_previous)
		{
			using func_t = function_type_t<decltype(&CalcCRC32_SIZE_P)>;
			REL::Offset<func_t*> func(Offset::CRC32Calculator::SizeOfSize);
			func(a_crc32, a_data, a_size, a_previous);
		}
