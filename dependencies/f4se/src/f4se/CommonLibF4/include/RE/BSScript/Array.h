...
namespace RE
{
	namespace BSScript
	{
		...
		{
		public:
			using base_array_type = BSTArray<Variable>;
			...
			using iterator = base_array_type::iterator;
			using const_iterator = base_array_type::const_iterator;
		...
		protected:
			...
			// members
			UInt32				unk04;		// 04
			Type				_type;		// 08 - base types 1-6
			UInt64				unk10;		// 10
			base_array_type		_arr;		// 18
