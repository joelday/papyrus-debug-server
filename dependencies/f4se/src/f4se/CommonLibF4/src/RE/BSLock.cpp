...
#include "f4se/GameTypes.h"  // BSReadWriteLock
...
namespace RE
{
	...
	//	func_t* func = EXTRACT_F4SE_MEMBER_FN_ADDR(::BSReadWriteLock, LockForRead, func_t*);
	//	func(this);
	//}
	...
	//	// TODO:
	//	func_t* func = EXTRACT_F4SE_MEMBER_FN_ADDR(::BSReadWriteLock, Unlock, func_t*);
	//	func(this);
	//}
	...
	//	func_t* func = EXTRACT_F4SE_MEMBER_FN_ADDR(::BSReadWriteLock, LockForWrite, func_t*);
	//	func(this);
	//}
