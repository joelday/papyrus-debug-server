...
#else
#define DIDPDS_VERSION_SEMVER  MAKE_STR(DIDPDS_VERSION_MAJOR) "." MAKE_STR(DIDPDS_VERSION_MINOR) "." MAKE_STR(DIDPDS_VERSION_PATCH) "-beta" DIDPDS_VERSION_BETA
#endif
