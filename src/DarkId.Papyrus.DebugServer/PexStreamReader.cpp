...
Pex::PexStreamReader::PexStreamReader(std::istream *stream) :
	m_Stream(stream),
...
Pex::PexStreamReader::~PexStreamReader()
{
}
 ...
 */
void Pex::PexStreamReader::read(Pex::Binary &binary)
{
 ...
 *
 */
void Pex::PexStreamReader::readHeader(Pex::Header &header)
{
 ...
 */
void Pex::PexStreamReader::read(Pex::StringTable &stringTable)
{
	auto len = getUint16();
 ...
 */
void Pex::PexStreamReader::read(Pex::DebugInfo &debugInfo)
{
 ...
 */
void Pex::PexStreamReader::read(Pex::UserFlags &userFlags)
{
 ...
 */
void Pex::PexStreamReader::read(Pex::Objects &objects)
{
	auto count = getUint16();
 ...
 */
void Pex::PexStreamReader::read(Pex::StructInfos &structInfos)
{
 ...
 */
void Pex::PexStreamReader::read(Pex::Variables &variables)
{
 ...
 */
void Pex::PexStreamReader::read(Pex::Properties &properties)
{
 ...
 */
void Pex::PexStreamReader::read(Pex::States &states)
{
 ...
 */
void Pex::PexStreamReader::read(Pex::Functions &functions)
{
	auto functionCount = getUint16();
 ...
 */
void Pex::PexStreamReader::read(Pex::Function &function)
{
 ...
 */
void Pex::PexStreamReader::read(Pex::TypedNames &typednames)
{
	auto nameCount = getUint16();
 ...
 */
void Pex::PexStreamReader::read(Pex::Instructions &instructions)
{
	auto instructionCount = getUint16();
 ...
 */
std::uint8_t Pex::PexStreamReader::getUint8()
{
	std::uint8_t value;
 ...
 */
std::uint16_t Pex::PexStreamReader::getUint16()
{
	std::uint16_t value;
	m_Stream->read(reinterpret_cast<char*>(&value), sizeof(value));
	if(!m_Stream)
...
#if SKYRIM
	return DarkId::Papyrus::DebugServer::ByteSwap(value);
#else
	return value;
#endif
}
 ...
 */
std::uint32_t Pex::PexStreamReader::getUint32()
{
	std::uint32_t value = 0;
	m_Stream->read(reinterpret_cast<char*>(&value), sizeof(value));
	if(m_Stream->gcount() != sizeof(value))
	{
		throw std::runtime_error("Error reading file");
	}
 ...
 */
Pex::StringTable::Index Pex::PexStreamReader::getStringIndex()
{
 ...
 * @return a short read from the file.
 */
std::int16_t Pex::PexStreamReader::getInt16()
{
	std::int16_t value;
	m_Stream->read(reinterpret_cast<char*>(&value), sizeof(value));
	if(!m_Stream)
 ...
 */
float Pex::PexStreamReader::getFloat()
{
	float value;
	m_Stream->read(reinterpret_cast<char*>(&value), sizeof(value));
	if(!m_Stream)
 ...
 */
std::time_t Pex::PexStreamReader::getTime()
{
 ...
 * @return a string.
 */
std::string Pex::PexStreamReader::getString()
{
	auto len = getUint16();
 ...
 * @return a Pew::Value.
 */
Pex::Value Pex::PexStreamReader::getValue()
{
